...
var messages = map[string]map[string]string{
	"en": {
		...
		"integrity_all_clean":            "✓ All integrity checks passed",
		"no_nested_manifests":            "✓ No nested manifests found",
		"no_parent_manifest":             "✓ No parent manifest detected",
		"all_workspaces_registered":      "✓ All workspaces registered",
		"nested_manifest_critical":       "🚨 CRITICAL: Nested manifest detected!",
		...
		"parent_manifest_warning":        "⚠ WARNING: Parent manifest detected!",
		...
		"unregistered_workspace_warning": "⚠ Found %d unregistered workspace(s):",
		...
		"remote_url_mismatch":            "⚠ Remote URL mismatch:",
		...
		"no_keep_files_clean":     "    ✓ No keep files - clean workspace",
		...
		"removing_hooks":          "→ Removing git hooks",
	...
	"ko": {
		...
		// Integrity check
		"integrity_check":                "Multirepo 구조 무결성 검사",
		"integrity_all_clean":            "✓ 모든 무결성 검사 통과",
		"no_nested_manifests":            "✓ 중첩된 manifest 없음",
		"no_parent_manifest":             "✓ 부모 manifest 없음",
		"all_workspaces_registered":      "✓ 모든 workspace 등록됨",
		"nested_manifest_critical":       "🚨 심각: 중첩된 manifest 발견!",
		"nested_manifest_path":           "    - %s",
		"nested_manifest_explanation":    "  이것은 잘못된 구조입니다. Workspace는 자체 manifest를 가질 수 없습니다.",
		"nested_manifest_fix":            "  중첩된 manifest 제거:",
		"nested_manifest_cmd":            "    rm %s",
		"parent_manifest_warning":        "⚠ 경고: 부모 manifest 감지!",
		"parent_manifest_path":           "  이 디렉토리는 다음 부모 multirepo의 일부입니다: %s",
		"parent_manifest_explanation":    "  이 위치에서 작업하면 부모 repository에 영향을 줄 수 있습니다.",
		"unregistered_workspace_warning": "⚠ %d개의 미등록 workspace 발견:",
		"unregistered_workspace_item":    "    - %s (manifest에 없음)",
		"unregistered_workspace_fix":     "  수정 방법:",
		"unregistered_workspace_cmd":     "    git multirepo sync",
		"remote_url_mismatch":            "⚠ Remote URL 불일치:",
		"remote_url_workspace":           "    Workspace: %s",
		"remote_url_expected":            "    예상:      %s",
		"remote_url_actual":              "    실제:      %s",
		...
		"no_keep_files_clean":     "    ✓ keep 파일 없음 - 깨끗한 workspace",
		...
		"install_hook_usage":      "checkout 후 자동 동기화를 위한 git hook 설치",
		"uninstall_hook_usage":    "자동 동기화 git hook 제거",
		"hook_added":              "Git hook 설치 성공",
		"hook_removed":            "Git hook 제거 성공",
		"hook_restored":           "백업에서 이전 hook 복원됨: %s",
		"hook_not_installed":      "Git hook이 설치되지 않았습니다",
		"hook_already_installed":  "Git hook이 이미 설치되어 있습니다",
		"removing_hooks":          "→ git 훅 제거 중",
		"hook_backup_warning":     "기존 post-checkout hook 백업됨: %s",
		"hook_howto":              "'git multirepo install-hook' 명령으로 자동 동기화를 활성화할 수 있습니다",
	},
}
